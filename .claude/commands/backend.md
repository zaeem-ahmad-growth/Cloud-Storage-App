...
argument-hint: <tab folder, e.g. 01-aso-playbook> or research
---
Load the backend context for: $ARGUMENTS

- If it names a tab folder (`01-aso-playbook`, `02-playstore-metadata`, `03-features-comparison`, `04-competitors-graphics`, `05-free-100-gb-offer`), read `docs/backend/<that folder>.md` in full. It holds the full source of the code that draws the tab and the full data the tab reads.
