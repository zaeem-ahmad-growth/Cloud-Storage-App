...
| [#g-icons](tabs/04-competitors-graphics.md#g-icons) | Icons | All 12 icons side by side, ours first | [L38](../tabs/04-competitors-graphics/index.html#L38) | `renderGraphics()` [L338-386](../assets/app.js#L338) | `graphics.apps`, `graphics.captureNote`, `graphics.guidance`, `graphics.overview`, `graphics.patterns`, `graphics.requirements`, `graphics.scope`, `graphics.sources`, `graphics.table` |
| [#g-features](tabs/04-competitors-graphics.md#g-features) | Feature graphics | All 12 feature graphics, ours first | [L47](../tabs/04-competitors-graphics/index.html#L47) | `renderGraphics()` [L338-386](../assets/app.js#L338)<br>`lbStep()` [L420-437](../assets/app.js#L420) | `graphics.apps`, `graphics.captureNote`, `graphics.guidance`, `graphics.overview`, `graphics.patterns`, `graphics.requirements`, `graphics.scope`, `graphics.sources`, `graphics.table`, `data.markets.US`, `mymeta` |
